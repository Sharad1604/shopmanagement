...
public class GeocodeService {
	...
	private String getFormattedAddress(Shop shop) {
		...
		if (Objects.nonNull(shop.getShopAddress())) {
			formattedAddress.append(shop.getShopAddress()).append(",");
		}
		if (Objects.nonNull(shop.getShopPostCode())) {
			formattedAddress.append(shop.getShopPostCode());
		}
